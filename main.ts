function roll_animation () {
    for (let index = 0; index < 5; index++) {
        val1.setImage(list[randint(0, 7)])
        pause(100)
        val2.setImage(list[randint(0, 7)])
        pause(100)
        val_3.setImage(list[randint(0, 7)])
        pause(100)
    }
}
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    roll_animation()
    val1.setImage(list[rand1])
    pause(100)
    val2.setImage(list[rand2])
    pause(200)
    val_3.setImage(list[rand3])
    pause(2000)
    if (rand1 == rand2 && rand1 == rand3 && rand1 == 7) {
        game.splash("Jackpot!")
    } else if (rand1 == rand2 && rand1 == rand3 && rand1 != 7) {
        game.splash("Match!")
    } else {
...
val1 = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
val1.setPosition(47, 61)
val2 = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
val2.setPosition(75, 61)
val_3 = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
...
sprites.food.bigCake,
sprites.food.bigDrumstick,
sprites.food.bigDonut,
